...
include('session.php');
	...
	$name = $_POST['name'];
     ...
     mysqli_query($con,"UPDATE product SET prod_qty=prod_qty+'$qty' where prod_id='$name'") or die(mysqli_error($con)); 
               
               mysqli_query($con,"INSERT INTO stockin(prod_id,stockin_qty,stockin_date) VALUES('$name','$qty','$date')")or die(mysqli_error($con));
